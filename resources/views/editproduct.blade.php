        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/{{$productSelect->city->slug}}/products/{{$productSelect->slug}}/edit" enctype="multipart/form-data">                        
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <img class="imgPreview" src="{{ asset('/storage/' . $productSelect->imgPath)}}" alt="">
                                <br><br>
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" value="{{$productSelect->name}}" class="form-control @error('name') is-invalid @enderror" name="name" required autocomplete="name" autofocus >
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-6" style="margin-bottom: 10px">
                                <textarea id="description"
                                    class="form-control @error('description') is-invalid @enderror" name="description"
                                     required autocomplete="description">{{$productSelect->description}}</textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <input style="max-width:100px" id="price" type="number"
                                    ...
                                    value="{{$productSelect->price}}" required autocomplete="price">
                            ...
                            <div class="col-md-6">
                                ...
                                <input style="max-width:100px; display: inline !important;" id="age" type="number"
                                    ...
                                    value="{{$productSelect->minage}}" required autocomplete="age">
                                ...
                                <input style="max-width:100px; display: inline !important;" id="age2" type="number"
                                    ...
                                    value="{{$productSelect->maxage}}" placeholder="130" value="{{ old('age2') }}" required autocomplete="age2">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="gender" type="text"
                                    class="form-control @error('gender') is-invalid @enderror" name="gender"  value="{{$productSelect->name}}" required autocomplete="gender">

                                    @foreach ($genders as $gender)
                                    <option @if($productSelect->gender->id == $gender->id) selected='selected' @endif  value="{{ $gender->id }}">{{ $gender->name }}</option>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check" id="rolesMan" @if($productSelect->gender->id == 2) style="display:none" @else style="display:block" @endif>   
                                    @foreach ($rolesMan as $role)
                                    
                                        <input 
                                        @foreach ($productSelect->valueparameters as $valueparameter)
                                            @if ($role->id == $valueparameter->id) checked  @endif                                         
                                        @endforeach                                        
                                        class="form-check-input" type="checkbox" name="role{{ $role->id }}" id="{{$role->id}}" value="{{$role->id}}">
                                ...
                                <div class="form-check" id="rolesWoman" @if($productSelect->gender->id == 1) style="display:none" @else style="display:block"  @endif>   
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="city" type="text" class="form-control @error('city') is-invalid @enderror"
                                    ...
                                    <option @if ($productSelect->city->slug == $city->slug) selected='selected' @endif value="{{ $city->id }}">{{ $city->name }}</option>
                                    @endforeach
